...
for mat in materials: 
    ...
    plt.plot(t/3600, amp_init*amp, label=mat[0], color=mat[3], linewidth=5)

#plt.title(f"Amplitude decay over 1 day by material", fontsize=24)
...
plt.ylabel('Time taken for amplitude to halve (h)',fontsize=18)
#plt.title("Time taken for amplitude to halve by material", fontsize=24)
...
for mat in materials:
    ...
    plt.plot(t_peaks, amp_peaks, linestyle='-', linewidth=4, color=mat[3], label=name)
